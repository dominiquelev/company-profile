    ...
    <section>
      <div className="container md:mx-auto md:px-10">
        ...
        <div>
          ...
          <div className=" text-justify">
            ...
            <p className="p-1 text-xl">
              ...
              cup with precision, and creating a space where conversations flow
              as smoothly as our coffee.
              <br />
              <br />
        ...
        <p className="text-justify text-xl">
          ...
          <br />
          <br />
          Join us at Ko.Kopian, where every pour tells a tale of passion,
          flavor, and the joy found in a cup well-crafted. Cheers to coffee
          moments that linger and memories that brew!"
        </p>
        <div>
          ...
          <div className="flex flex-col gap-20 md:flex-row">
            <Card className="overflow-hidden border-none bg-transparent">
              <div className="relative h-[460px] w-[300px] mx-auto">
                <Image
              ...
              <CardHeader>
                ...
                <CardDescription className="text-justify">
                  Through countless trials & errors, Andrew believed that a
                  great brand requires great people and a great message.
                </CardDescription>
              </CardHeader>
            </Card>
            <Card className="overflow-hidden border-none bg-transparent">
              ...
              <CardHeader>
                ...
                <CardContent className="text-center">Co-Founder</CardContent>
                <CardDescription className="text-justify">
                  Along with adaptability and strength to learn, Dominique
                  agrees that a sharp mentality from the team will drive better
                  output quality.
                </CardDescription>
              </CardHeader>
            </Card>
          ...
          <div className="grid  grid-cols-1 md:grid-cols-2">
            <div>
              ...
              <p className="text-balance text-justify text-2xl">
                Ko.Kopian was founded by a group of friends with a shared
                passion for coffee. They opened their first location in a cozy
                corner of the city, offering a curated selection of specialty
                beans and expertly brewed beverages.
              </p>
            </div>
            <div></div>
          </div>
        ...
        <div className=" pb-[274px]">
          <div className="text-justify">
            <p className="p-1 text-xl">
              ...
              member is valued, respected, and empowered to thrive.
              Collaboration is at the heart of our culture, as we believe that
              great ideas emerge from diverse perspectives working together
              towards a common goal. Integrity and transparency are core values
              that guide our interactions with customers, suppliers, and each
              other, ensuring honesty and trustworthiness in all that we do.
              <br />
              <br />
              ...
              practices in our operations, we strive to minimize our
              environmental footprint and contribute positively to the planet.
              We believe in giving back to the communities that support us,
              whether through charitable initiatives, volunteer work, or
              partnerships with local organizations.
            </p>
          </div>
          <p className="p-1 text-justify text-xl">
            As a team of coffee aficionados, we take pride in delivering not
            just a beverage, but an artful creation that embodies our dedication
            to quality. Whether you're a seasoned coffee connoisseur or a casual
            sipper, Ko.Kopian promises an immersive journey into the world of
            coffee.
            <br />
            <br />
            At Ko.Kopian, passion fuels our endeavors, excellence is our
            standard, and innovation drives us forward. We celebrate
            individuality and creativity, encouraging our team members to
            explore their interests and pursue their passions both within and
            outside of the coffee world. Together, we share a dedication to
            delivering memorable experiences, one cup at a time, while staying
            true to our values and making a positive impact on the world around
            us.
          </p>
        </div>
      </div>
